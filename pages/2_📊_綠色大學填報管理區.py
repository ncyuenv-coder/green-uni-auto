...
<style>
    ...
    /* 展開內容區底色與字體放大 */
    div[data-testid="stExpander"] details[open] > div:nth-child(2) { background-color: #F4F6F7 !important; border: 2px solid #738A96; border-top: none; border-radius: 0 0 6px 6px; padding: 15px; }
    div[data-testid="stExpander"] details[open] > div:nth-child(2) div[data-testid="stMarkdownContainer"] p { font-size: 1.15em !important; line-height: 1.6; color: #2C3E50; }
    div[data-testid="stExpander"] details[open] > div:nth-child(2) div[data-testid="stMarkdownContainer"] li { font-size: 1.15em !important; line-height: 1.6; color: #2C3E50; }
        ...
        if view_item != "請選擇...":
            ...
            for idx, row in df_q_records.iterrows():
                ...
                for i in range(1, 11):
                    ...
                    if fid: files_for_u.append({'id': fid, 'desc': desc}) # 已移除強制加上的 [單位] 標籤
